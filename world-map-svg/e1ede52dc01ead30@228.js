// https://observablehq.com/@d3/projection-comparison@228
...
function _map(heightRed,heightBlue,DOM,width,d3,outline,graticule,land,red,blue)
{
...
function _heightRed(fitWidth,red){return(
fitWidth(red)
)}

function _heightBlue(fitWidth,blue){return(
fitWidth(blue)
)}

function _fitWidth(d3,width,outline){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("map")).define("map", ["heightRed","heightBlue","DOM","width","d3","outline","graticule","land","red","blue"], _map);
  ...
  main.variable(observer("heightRed")).define("heightRed", ["fitWidth","red"], _heightRed);
  main.variable(observer("heightBlue")).define("heightBlue", ["fitWidth","blue"], _heightBlue);
  main.variable(observer("fitWidth")).define("fitWidth", ["d3","width","outline"], _fitWidth);
